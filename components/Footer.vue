        ...
        <v-container>
          <v-row>
            <v-col cols="12" md="4" lg="3" sm="12">
              <img alt="" src="../static/logo.png" class="responsive_img">
              <p class="footer_paragraph text--white">
                {{school.description}}
              </p>
            </v-col>
            <v-col cols="12" md="4" lg="3" sm="6">
              <h2 class="footer_title_text text-center text-md-center text-lg-center text-sm-left">{{fr_dict.important_websites}}</h2>
            ...
            <v-col cols="12" md="4" lg="3" sm="6">
              <h2 class="footer_title_text mb-2">{{fr_dict.contact_us}}</h2>
              <a class=" mr-3" :href="school.facebook"><v-icon size="28" color="primary">mdi-facebook</v-icon></a>
              <a class=" mr-3" :href="school.youtube"><v-icon size="28" color="primary">mdi-youtube</v-icon></a>
              <a :href="school.instagram"><v-icon size="28" color="primary">mdi-instagram</v-icon></a>
              <hr class="mt-4" style="width: 80%; background-color: #787878">
              <v-row class="mt-3 ml-1">
                <a class=" mr-3" href="#"><v-icon size="20" color="primary">mdi-calendar-range</v-icon> <span style="color: white">{{school.working_days}}</span></a>
                <a class=" mr-3" href="#"><v-icon size="20" color="primary">mdi-clock-time-eight</v-icon> <span style="color: white">{{school.working_hours}}</span></a>
              </v-row>
            </v-col>
          </v-row>
        </v-container>
